...
namespace App\Http\Controllers\University\Program;
...
class ProgramController extends Controller
{
    ...
    public function all()
    {
        ...
        return view('university.program.all', compact(['programs']));
    }
    ...
    public function active()
    {
        ...
        return view('university.program.active', compact(['programs']));
    }
    ...
    public function inactive()
    {
        ...
        return view('university.program.inactive', compact(['programs']));
    }
    ...
    public function create()
    {
        ...
        return view('university.program.create', compact(['faculties']));
    }
    ...
    public function edit($page, $id)
    {
        if ($page == 'all') {
            ...
            $page_title = 'Inactive programs';
        } else {
            $page_title = 'Create program';
        }

        $program = Program::whereHas('faculty', function ($builder) {
            $builder->whereUniversity_id(auth()->user()->id);
        })->whereId($id)->firstOrfail();
        $langTests = LanguageTest::whereStatus(true)->get();

        return view('university.program.edit', compact(['page', 'page_title', 'program', 'langTests']));
    }
    ...
    public function store(Request $request)
    {
        ...
        $faculty = Faculty::whereId($request->faculty_id)->whereUniversity_id(auth()->user()->id)->whereStatus(true)->firstOrFail();
        $pid = $faculty->university_id . strtotime(now()) . $request->faculty_id;
        ...
        return redirect()->route('university.program.edit', ['id' => $program->id, 'page' => 'all']);
    }
    ...
    public function update(Request $request, $program_id)
    {
        ...
        $program = Program::whereHas('faculty', function ($builder) {
            $builder->whereUniversity_id(auth()->user()->id);
        })->whereId($program_id)->firstOrfail();
