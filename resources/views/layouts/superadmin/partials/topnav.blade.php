                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notoficationlink">
                                    <div class="notification-dropdown-title">
                                        <h4>{{ __('Recent Notifications') }}</h4>
                                    </div>

                                    <ul class="list-unstyled">
                                        <li class="media dropdown-item" data-href="#">
                                            <span class="action-icon badge badge-primary-inverse notification-{{ rand(1,6) }}"><i class="feather icon-bell"></i></span>
                                            <div class="media-body">
                                                <h5 class="action-title">$135 received lorem12</h5>
                                        ...
                                        <li class="text-center on-hover-ucap p-t-10 p-b-5" data-href="#">
                                            <h6 class="text-center text-bold text-dark on-hover-ucap">{{ __('See All Notifications') }}</h6>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="userbox">
                                        <ul class="list-unstyled mb-0">
                                            <li class="media dropdown-item">
                                                <a href="{{ route('superadmin.administrator.show', ['id' => auth()->user()->id]) }}" class="profile-icon">
                                                    <i class="ti-user"></i>
