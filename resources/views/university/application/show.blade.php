...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        @if ($page == 'all')
            <a href="{{ route('university.application.all') }}">{{ __('All Applications') }}</a>
        @elseif ($page == 'processing')
            <a href="{{ route('university.application.processing') }}">{{ __('Processing Applications') }}</a>
        @elseif ($page == 'approved')
            <a href="{{ route('university.application.approved') }}">{{ __('Approved Applications') }}</a>
        @elseif ($page == 'pending')
            <a href="{{ route('university.application.pending') }}">{{ __('Pending Applications') }}</a>
        @else
            <a href="{{ route('university.application.rejected') }}">{{ __('Rejected Applications') }}</a>
        @endif
    </li>
...
@section('action')
    ...
    <a href="{{ messenger_route() }}" target="_blank" class="btn btn-custom text-bold float-right confirm" confirm="Are you sure want to Chat with the Applicant?">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if (!is_null($data->representative_id))
                                                    <a href="{{ route('university.representative.show', ['id' => $data->representative_id, 'page' => 'all']) }}" target="_blank" class="text-bold text-ucap">{{ optional($data->representative)->name }}</a>
                                                @else
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="btn-group mr-2">
                                                    <div class="dropdown">
                                                        ...
                                                        @include('university.application.modals.representative')
