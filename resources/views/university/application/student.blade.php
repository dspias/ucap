...
@section('page_title', __($page_title. ' | Details | Student Details'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        @if ($page == 'all')
            <a href="{{ route('university.application.all') }}">{{ __($page_title) }}</a>
        @elseif ($page == 'processing')
            <a href="{{ route('university.application.processing') }}">{{ __($page_title) }}</a>
        @elseif ($page == 'accepted')
            <a href="{{ route('university.application.accepted') }}">{{ __($page_title) }}</a>
        @elseif ($page == 'pending')
            <a href="{{ route('university.application.pending') }}">{{ __($page_title) }}</a>
        @else
            <a href="{{ route('university.application.rejected') }}">{{ __($page_title) }}</a>
        @endif
    </li>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'avatar']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('avatar'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'avatar']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'nid_birth']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('nid_birth'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'nid_birth']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'passport']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('passport'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'passport']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'language_certificate']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('language_certificate'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'language_certificate']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'signature']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('signature'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'signature']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 60%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'additionals']) }}" class="text-ucap text-bold">{{ optional(optional($student->student)->getFirstMedia('additionals'))->name }}</a>
                                </td>
                                <td class="text-center" style="width: 10%;">
                                    <a href="{{ route('university.student.download', ['id' => $student->id, 'type' => 'additionals']) }}" class="btn btn-custom btn-sm text-bold">
                                        <i class="ti-download"></i>
                                    </a>
                                </td>
                                @else
                                ...
                                <table class="table table-responsive-sm table-bordered mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row" class="text-center">
                                                <a href="{{ route('university.student.education_download', ['model_id' => $education->id]) }}" class="btn btn-custom btn-sm text-bold">
                                                    <i class="ti-download"></i>
                                                </a>
                                            </td>
                                        </tr>
