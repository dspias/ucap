...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        @if ($page == 'all')
            <a href="{{ route('university.representative.all') }}">{{ __($page_title) }}</a>
        @elseif ($page == 'active')
            <a href="{{ route('university.representative.active') }}">{{ __($page_title) }}</a>
        @else
            <a href="{{ route('university.representative.inactive') }}">{{ __($page_title) }}</a>
        @endif
    </li>
...
@section('action')
    @php
        if ($page == 'all')
            $back = 'university.representative.all';
        elseif ($page == 'active')
            $back = 'university.representative.active';
        else
            $back = 'university.representative.inactive';
    @endphp
    <a href="{{ route($back) }}" class="btn btn-custom">
        <i class="feather icon-arrow-left mr-1"></i>
        {{ __('Back') }}
    </a>
    <a href="{{ route('university.representative.edit', [$data->id]) }}" class="btn btn-custom bg-ucap confirm" confirm="Are you sure want to Edit this Course?">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-header">
                ...
                @include('university.representative.modals.assign_application')
            </div>
            <div class="card-body">
                <div class="table-responsive">
