...
<div class="row m-b-30">
    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <form action="{{ route('university.representative.update', [$representative->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control @error('language') is-invalid @enderror" name="language" id="language" required >
                                    ...
                                    @include('university.representative.apart.languages')
                                </select>
                                @error('language')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
