...
@section('page_title', __('Create UCAP Admin'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Create UCAP Admin') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Administrator') }}</li>
    <li class="breadcrumb-item active">{{ __('Create UCAP Admin') }}</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <form action="{{ route('superadmin.administrator.store') }}" method="post" enctype="multipart/form-data">
                @csrf
