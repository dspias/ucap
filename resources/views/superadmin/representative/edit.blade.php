...
@section('page_title', __('Edit representative'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Edit UCAP representative') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('UCAP representative') }}</li>
    <li class="breadcrumb-item active">{{ __('Edit UCAP representative') }}</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <form action="{{ route('superadmin.representative.update', [$representative->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control" name="university_id" id="university" required >
                                    ...
                                    <option @if( optional($representative->representative)->university_id == $data->id) selected @endif value="{{ $data->id }}">{{ $data->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control @error('language') is-invalid @enderror" name="language" id="language" required >
                                    ...
                                    @include('superadmin.representative.apart.languages')
                                </select>
                                @error('language')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
