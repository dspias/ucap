...
@section('page_name')
    <b class="text-uppercase">{{ __('Assign New Representative') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Representatives') }}</li>
    <li class="breadcrumb-item active">{{ __('Assign New Representative') }}</li>
@endsection
...
<div class="row m-b-30">
    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <form action="{{ route('superadmin.representative.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="university">{{ __('University') }}<sup class="required">*</sup></label>
                                <select class="select2-single form-control" name="university_id" id="university" required >
                                    <option value="" aria-disabled="true" >{{ __('Select University *') }}</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Min 8 Char Password" required>
                                @error('password')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Min 8 Char Password" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" placeholder="Ex: +880 1712 345678" id="phone" name="phone" required>
                                @error('phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
