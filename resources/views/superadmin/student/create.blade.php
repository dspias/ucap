...
@section('page_name')
    <b class="text-uppercase">{{ __('Create Student') }}</b>
@endsection
            ...
            <form action="#" method="post">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="avatar-upload">
                                <div class="avatar-edit">
                                    <input type='file' name="avatar" id="imageUpload" class="@error('avatar') is-invalid @enderror" accept=".png, .jpg, .jpeg" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="last_name">{{ __('First Name') }}<sup class="required">*</sup></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="birthdate">{{ __('Date Of Birth') }}<sup class="required">*</sup></label>
                                <input type="text" name="birthdate" id="autoclose-date" class="datepicker-here form-control @error('birthdate') is-invalid @enderror" placeholder="dd/mm/yyyy" aria-describedby="basic-addon2"/>
                                @error('birthdate')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control @error('language') is-invalid @enderror" name="language" id="language" required >
                                    ...
                                    @include('superadmin.student.apart.languages')
                                </select>
                                @error('language')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 pt-3">
                            <h3 class="text-dark">{{ __('Upload Documents') }}</h3>
                            <hr>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nid_bc">{{ __('NID / Birth Certificate') }}<sup class="required">*</sup></label>
                                <input type="file" class="form-control @error('nid_bc') is-invalid @enderror" name="nid_bc" placeholder="Upload NID/Birth Certificate" required>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload NID / Birth Certificate Copy in "PDF/JPEG/JPG" Format.') }}]]</small>
                                @error('nid_bc')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="passport">{{ __('Passport') }}<sup class="required">*</sup></label>
                                <input type="file" class="form-control @error('passport') is-invalid @enderror" name="passport" placeholder="Upload Passport" required>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload Passport Copy in "PDF/JPEG/JPG" Format.') }}]]</small>
                                @error('passport')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="language_test">{{ __('Language Test') }}<sup class="required">*</sup></label>
                                <select name="language_test" class="form-control @error('language_test') is-invalid @enderror" id="language_testId" required >
                                    <option value="" aria-disabled="true">{{ __('Select Test *') }}</option>
                                    <option value="IELTS">{{ __('IELTS') }}</option>
                                    <option value="GRE">{{ __('GRE') }}</option>
                                </select>
                                @error('language_test')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="language_file">{{ __('Language Test Result and Certificate') }}<sup class="required">*</sup></label>
                                <input type="file" class="form-control @error('language_file') is-invalid @enderror" name="language_file" placeholder="Upload Passport" multiple required>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload Language Test Result and Certificate Copy in "PDF/JPEG/JPG" Format.') }}]]</small>
                                @error('language_file')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="certificate_transcript">{{ __('Educational Certificates & Transcripts') }}<sup class="required">*</sup></label>
                                <input type="file" class="form-control @error('certificate_transcript') is-invalid @enderror" name="certificate_transcript" placeholder="Upload Passport" multiple required>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload Educational Certificates & Transcripts Copy in "PDF/JPEG/JPG" Format.') }}]]</small>
                                @error('certificate_transcript')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="signature">{{ __('Declaration/Signature') }}<sup class="required">*</sup></label>
                                <input type="file" class="form-control @error('signature') is-invalid @enderror" name="signature" placeholder="Upload Passport" multiple required>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload Declaration/Signature Copy in "JPEG/JPG/PNG" Format.') }}]]</small>
                                @error('signature')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="additional">{{ __('Additional Documents') }}</label>
                                <input type="file" class="form-control @error('additional') is-invalid @enderror" name="additional" placeholder="Upload Passport" multiple>
                                <small class="text-info">[[<span class="text-danger">{{ __('Note') }}:</span> {{ __('Upload Additional Documents Copy in "PDF/JPEG/JPG" Format.') }}]]</small>
                                @error('additional')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
