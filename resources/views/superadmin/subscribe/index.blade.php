...
@section('page_title', __('Subscriber\'s'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Subscriber\'s') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item active">{{ __('Subscriber\'s') }}</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title float-left">{{ __('All Subscriber\'s') }}</h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <div class="badge badge-success">{{ __('Inactive') }}</div>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
