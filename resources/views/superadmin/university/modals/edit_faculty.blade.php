                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group text-left">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="{{ __('Ex: Department of Mathematics') }}" required>
                                @error('name')
