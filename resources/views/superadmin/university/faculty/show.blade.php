...
@endphp
    <b class="text-capitalize">
        ...
        <h6 class="text-center-sm">
            <a href="{{ route('superadmin.university.show', ['id' => $uni_id, 'page' => 'all']) }}" class="text-muted text-center">
                {{ optional($faculty->university)->name }}
            </a>
        </h6>
    </b>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('superadmin.university.show', ['id' => optional($faculty->university)->id, 'page' => 'all']) }}">
            {{ __('Details') }}
        </a>
    </li>
    <li class="breadcrumb-item active">{{ __('Faculty Details') }}</li>
@endsection
...
@section('action')
    ...
    @include('superadmin.university.faculty.modals.edit_faculty')

    <a href="{{ route('guest.university.show', ['id' => decbin($uni_id), 'name' => get_name(optional($faculty->university)->name)]) }}" target="_blank" class="btn btn-custom-outline" data-toggle="tooltip" data-title="{{ __('See preview in live website') }}">
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-header">
                ...
                <a href="javascript:void(0);" data-toggle="modal" data-target="#createProgram" class="btn btn-custom bg-ucap btn-sm float-right text-bold">{{ __('Assign New') }}</a>
                ...
                <div class="table-responsive">
                    <table id="programTable" class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr data-href="{{ route('superadmin.university.faculty.program.edit', ['program_id' => decbin($program->id)]) }}">
