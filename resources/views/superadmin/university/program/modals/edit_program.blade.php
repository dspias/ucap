                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group text-left">
                                ...
                                <input type="text" value="{{ $program->name ?? old('name') }}" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="{{ __('Ex: Department of Mathematics') }}" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group text-left">
                                <label for="short_name">{{ __('program short_name') }}<sup class="required">*</sup></label>
                                <input type="text" value="{{ $program->short_name ?? old('short_name') }}" class="form-control @error('short_name') is-invalid @enderror" name="short_name" placeholder="{{ __('Ex: Department of Mathematics') }}" required>
                            </div>
                        </div>
