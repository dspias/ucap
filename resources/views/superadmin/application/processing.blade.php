...
@section('page_name')
    <b class="text-uppercase">{{ __('Processing Applications') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Application') }}</li>
    <li class="breadcrumb-item active">{{ __('Processing Applications') }}</li>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title float-left">{{ __('Processing Applications') }}</h5>
                                        ...
                                        <div class="btn-group mr-2">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btn_id_no_01">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('superadmin.application.show', ['page' => 'processing', 'id' => decbin($data->id), 'application_id' => $data->aid]) }}">
