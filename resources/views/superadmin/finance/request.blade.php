...
@section('page_title', __('Payment Requests'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Payment Requests') }}</b>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Payment Requests') }}</li>
@endsection
                    ...
                    <table id="dataTable" class="table table-bordered table-responsive-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{ __('Pay To') }}</th>
                        ...
                        <tbody>
                            {{-- @foreach ($payments as $sl => $payment) --}}
                                <tr data-href="{{ route('superadmin.finance.make.payment', ['invoice_id' => 1]) }}">
                                    <td class="text-center">{{ 'serial($sl)' }}</td>
                                    <td class="text-ucap text-bold text-center">{{ 'UCAPINV00000001' }}</td>
                                    <td class="text-center">{{ 'UserFullNameHere' }}</td>
