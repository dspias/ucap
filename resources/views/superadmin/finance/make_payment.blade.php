...
@section('page_title', __('Make Payment'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Make Payment') }}</b>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Make Payment') }}</li>
@endsection
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="invoice-footer-btn">
                                    <a href="javascript:window.print()" class="btn btn-dark py-1 font-16"><i class="feather icon-printer mr-2"></i>Print</a>
                                    <a href="#" class="btn btn-custom bg-ucap py-1 font-16 confirm" confirm="{{ __('Are you sure want to make the Payment?') }}"><i class="feather icon-send mr-2"></i>{{ __('Make Payment') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>                                   
