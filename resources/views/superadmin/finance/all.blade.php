...
@section('page_title', __('All Payments'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('All Payments') }}</b>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('All Payments') }}</li>
@endsection
                    ...
                    <table id="dataTable" class="table table-bordered table-responsive-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{ __('Paid To') }}</th>
                        ...
                        <tbody>
                            {{-- @foreach ($payments as $sl => $payment) --}}
                                <tr data-href="{{ route('superadmin.finance.details', ['invoice_id' => 1]) }}">
