...
@section('page_title', __('Edit UCAP Centre'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Edit UCAP Centre') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('UCAP Centre') }}</li>
    <li class="breadcrumb-item active">{{ __('Edit UCAP Centre') }}</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <form action="{{ route('superadmin.centre.update', [$centre->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="avatar-upload">
                                <div class="avatar-edit">
                                    <input type='file'  value="{{ optional($centre->centre)->first_name }}" name="avatar" id="imageUpload" class="@error('avatar') is-invalid @enderror" accept=".jpg, .jpeg" />
                                ...
                                <div class="avatar-preview">
                                    ...
                                    @if(!is_null($url = has_media($centre->centre, 'avatar', 'thumb')))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"  value="{{ optional($centre->centre)->first_name }}" name="first_name" placeholder="Ex: John"  required>
                                @error('first_name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('middle_name') is-invalid @enderror"  value="{{ optional($centre->centre)->middle_name }}" name="middle_name" placeholder="Ex: Kevin">
                                @error('middle_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror"  value="{{ optional($centre->centre)->last_name }}" name="last_name" placeholder="Ex: Doe" required>
                                @error('last_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control @error('gender') is-invalid @enderror"  value="{{ optional($centre->centre)->first_name }}" name="gender" id="gender" required >
                                    <option value="" aria-disabled="true" >{{ __('Select Gender *') }}</option>
                                    <option @if( optional($centre->centre)->gender == 'Male') selected @endif value="Male">{{ __('Male') }}</option>
                                    <option @if( optional($centre->centre)->gender == 'Female') selected @endif value="Female">{{ __('Female') }}</option>
                                    <option @if( optional($centre->centre)->gender == 'Other') selected @endif value="Other">{{ __('Other') }}</option>
                                </select>
                                @error('gender')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"  value="{{ optional($centre->centre)->phone }}" name="phone" required>
                                @error('phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="country" class="countries form-control @error('country') is-invalid @enderror presel-{{ optional($centre->centre)->country }}" id="countryId" required >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="state" class="states form-control @error('state') is-invalid @enderror  presel-{{ optional($centre->centre)->state }}" id="stateId" required >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="city" class="cities form-control @error('city') is-invalid @enderror  presel-{{ optional($centre->centre)->city }}" id="cityId" required >
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" rows="3" placeholder="Address" required>{{ optional($centre->centre)->address }}</textarea>
                                @error('address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
...
@section('custom_script')
    ...
    <script>
        $(document).ready(function(){
            var language = '{{ optional($centre->centre)->language }}';
            ...
            let dob = '{{ optional($centre->centre)->dob }}';
