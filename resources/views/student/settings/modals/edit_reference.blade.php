<div class="modal fade" id="editReference" tabindex="-1" role="dialog" aria-labelledby="editReference-label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 600px;" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white" id="editReference-label">{{ __('Edit Reference') }}</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('student.settings.reference.update') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" id="reference_id" name="id" value="">
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-theme bg-ucap">{{ __('Update Reference') }}</button>
                </div>
            </form>
        </div>
    </div>
