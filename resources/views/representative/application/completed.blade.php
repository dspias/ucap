...
@section('page_name')
    <b class="text-uppercase">{{ __('Completed Applications') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Applications') }}</li>
    <li class="breadcrumb-item active">{{ __('Completed Applications') }}</li>
@endsection
                    ...
                    <div class="table-responsive">
                        <table id="applicationTable" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{ route('representative.application.show', ['page' => 'completed', 'app_id' => decbin($data->id)]) }}">
                                    <td>{{ $sl+1 }}</td>
