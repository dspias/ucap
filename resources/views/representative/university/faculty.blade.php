...
@section('page_name')
@php
    $status = ($faculty->status == true) ? '<span class="badge badge-success">Activeted</span>' : '<span class="badge badge-danger">Inactiveted</span>';
@endphp
...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('representative.university.index') }}">
            {{ __('My University') }}
        </a>
    </li>
    <li class="breadcrumb-item">
    ...
    <li class="breadcrumb-item active">{{ __('Program Details') }}</li>
@endsection
                ...
                <div class="table-responsive">
                    <table id="programTable" class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr data-href="{{ route('guest.program.show', ['program_id' => decbin($program->id), 'program_title' => get_name($program->name)]) }}">
