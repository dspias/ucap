...
@section('page_title', __('My University'))
...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('My University') }}</li>
@endsection
        ...
        <div class="card university-card m-b-30">
            <div class="card-header p-0">
                ...
                <div class="profilebox text-center">
                    ...
                    <img src="{{ show_image($url) }}" class="img-fluid img-thumbnail mb-3 rounded-circle university-logo" width="100px" height="100px" alt="profile">
                    @else
                ...
                <div class="table-responsive">
                    <table id="facultyTable" class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr data-href="{{ route('representative.university.faculty', ['uni_id' => decbin($university->id), 'faculty_id' => decbin($faculty->id)]) }}">
